...
public class RoyalIRCBot {
    ...
    public RoyalIRCBot(final AvBot plugin, ConfigurationSection cs, ListenerManager<PircBotX> lm) {
        ...
        cb.setServer(hostname, port)
                ...
                .setLogin(cs.getString("login", "AvBot"))
                .setVersion("AvBot" + AvBot.version)
